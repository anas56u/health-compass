...
class _DoctorInfoScreenState extends State<DoctorInfoScreen> {
  ...
  Future<void> sendDoctorDataToFirebase() async {
    ...
    try {
      ...
      // الإرسال إلى كولكشن جديد اسمه 'doctors'
      await FirebaseFirestore.instance.collection('doctors').add(doctorData);

      showsnackbar(context, massage: "تم حفظ بيانات الطبيب بنجاح");

      // هنا يمكنك التوجيه للصفحة التالية
                  ...
                  child: Form(
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 20),
                        GestureDetector(
                          onTap: sendDoctorDataToFirebase,
                          child: custom_button(
                            onPressed: sendDoctorDataToFirebase,
                            buttonText: 'تأكيد',
                          ),
                        ),
                        Divider(
