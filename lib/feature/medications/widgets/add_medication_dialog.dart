...
class _AddMedicationDialogState extends State<AddMedicationDialog> {
  ...
  void _handleSubmit() async {
    ...
    for (int i = 0; i < _selectedDays.length; i++) {
      if (_selectedDays[i]) {
        int dayForNotification = (i == 0) ? 7 : i; 
        selectedDayIndices.add(dayForNotification);
      }
    }
...
final int notificationId = Random().nextInt(100000);
    ...
    final medication = MedicationModel(
      ...
      notificationId: notificationId, // <--- تمرير الـ ID الجديد
    );
    try {
      await NotificationService().scheduleMedicationReminder(
        id: notificationId,
        title: "وقت دواء: ${medication.medicationName}",
